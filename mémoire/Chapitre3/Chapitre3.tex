...
\section{Training}
     ...
     Nous utilisons Google colab car il offre un accès gratuit, puissant et rapide au GPU.
      ...
      \begin{figure}[H]
           \centering
           \includegraphics[height=2cm,width=5cm]{Chapitre3/y3-7.png}
      ...
      \begin{figure}[H]
           \centering
           \includegraphics[height=10cm,width=16cm]{Chapitre3/y3-8.png}
...
\section{Testing}
     ...
     \subsection{YOLOv3}
      ...
      \paragraph{-} Dans cette étude, nous constatons que  la précision moyenne  est faible $12.12\%$ et nous avons remarqué que dans certains cas, nous avons détecté le modèle (www) dans le modèle (https).
